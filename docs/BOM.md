...
- `invoice.data_uri` — egress / output (fetch; equality via URI path / `ni:`)
- `invoice.ingress_data_uri` — ingress transport
- `invoice.integration_data_uri` — Plant integration outputs after the hotF (durable CAS copy of data downloaded from MinIO scratch)
