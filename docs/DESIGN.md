...
* Applied discipline for **Functions (FaaS)**
  ...
  * **Machine Learning Engineering** involves the development, training, performance optimizing, and deployment of machine learning models as a scalable **Integration** function composed in Process [REPL(aC)] and dispatched onto Plant by InfraFunction (FaaS). 
  * **Data Analysis** involves evaluating performance of and implimenting the Process [REPL(aC)] using a data processing language and sheduling them for submition to the InfraFunction [FaaS] for execution.
