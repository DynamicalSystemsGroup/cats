...
|------------|------------------|---------------------|---------------------|
| **TransportPort** | Process ingress / egress / integration_cache (`n=1`) | `TransportContext` | **CAS** materialize/`put_tree` for `ni:`; Docker Kubo peers + Bitswap for **legacy CID** only |
