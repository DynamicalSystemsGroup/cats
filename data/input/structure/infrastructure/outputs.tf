output "docker_compose_minio_scratch_id" {
  description = "Identifier of the shell_script resource that brings up scratch MinIO; used by module.plant's depends_on to sequence after this module."
  value       = shell_script.docker_compose_minio_scratch.id
}
